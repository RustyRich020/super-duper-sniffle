// Ported from project/forms-rich.js — bespoke Example + "Why it matters" content
// keyed by form id (snake of code) -> exact section label -> { ex, why }.

export type RichEntry = { ex?: string; why?: string };
export type Rich = Record<string, Record<string, RichEntry>>;
